...
A Flutter plugin for the Ottu Checkout SDK integration on iOS.
  ...
  s.resource_bundles = {
    'ottu_flutter_checkout_privacy' => ['ottu_flutter_checkout/Sources/ottu_flutter_checkout/PrivacyInfo.xcprivacy'],
    'ottu_flutter_checkout_resources' => ['ottu_flutter_checkout/Sources/ottu_flutter_checkout/Resources/**/*']
  }
