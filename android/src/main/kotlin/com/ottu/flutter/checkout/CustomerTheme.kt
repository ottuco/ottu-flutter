...
data class CustomerTheme(
    ...
    val selectPaymentMethodHeader: TextStyle?,
    val title: TextStyle?,
    val subtitle: TextStyle?,
    val feesTitle: TextStyle?,
    val feesSubtitle: TextStyle?,
    ...
    val selectPaymentItemTitleBackgroundColor: ColorState?,
    val paymentItemBackgroundColor: ColorState?,
    val paymentItemDescriptionTextColor: ColorState?,
    val paymentItemBorderColor: ColorState?,
    val paymentItemBorderWidth: Float?,
    val paymentItemCornerRadius: Float?,
